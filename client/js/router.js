;(function($) {	
  ...
  var mod = $.sammy('#pnlBody', function() {
    ...
    */
    ...
    /**FACTURACION APP */
    this.get('#sincronizar',        function(){this.partial(vw+'/facturacion/sincronizar.html');});
    this.get('#facturar',        function(){this.partial(vw+'/facturacion/facturas.html');});
    this.get('#clientes',        function(){this.partial(vw+'/facturacion/listaClientes.html');});
    this.get('#parametricas',        function(){this.partial(vw+'/facturacion/listaRegFacturados.html');});
    this.get('#perfilOffLine',        function(){this.partial(vw+'/facturacion/listaRegMasivo.html');});
    /**QR*/
