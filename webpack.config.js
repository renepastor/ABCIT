...
module.exports = {
  ...
  output: {
    //path: path.resolve(__dirname, ruta_public+'static/'),
    path: path.resolve(__dirname, ruta_public+''),
    filename: 'bundle.js'
  },
  devServer: {
  ...
  plugins: [
    ...
    new WebpackPluginCopy([
      ...
      { from: 'client/js/ckeditor.js', to: 'ckeditor.js'},
      { from: 'client/js/lang', to: 'lang'},

      { from: 'client/img/symbolOn.png', to: 'img/symbolOn.png'},
      { from: 'client/img/symbol.png', to: 'img/symbol.png'},
      { from: 'client/img/favicon.ico', to: 'img/favicon.ico'},
